...
} from './dades.js?v=f841b84';
import {
    clauAleatoria, paraulaDelDia, manualDelDia, triarParaula,
    marge, rondesPersonalitzades,
} from './objectius.js?v=f841b84';
import * as personalitzat from './personalitzat.js?v=f841b84';
import { Partida, RESULTAT, formatarTemps } from './motor.js?v=f841b84';
import * as ui from './ui.js?v=f841b84';
import * as dialecte from './dialecte.js?v=f841b84';
import {
